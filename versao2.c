...
void dijkstra(ListaAdj *grafo, int numVertices, int verticeInicial, int verticeChegada)
{
    ...
    while (heap->tamanho > 0)
    {
        ...
        if (atual.vertice == verticeChegada)
        {
            while (anteriores[atual.vertice] != -1)
            {
                printf("%d <- ", atual.vertice);
                atual.vertice = anteriores[atual.vertice];
            }
            printf("%d\n", verticeInicial);
...
int main()
{
    ...
    int verticeInicial, verticeChegada;
    printf("Informe o vertice de partida: ");
    scanf("%d", &verticeInicial);
    printf("Informe o vertice de chegada: ");
    scanf("%d", &verticeChegada);
    dijkstra(grafo, numVertices, verticeInicial, verticeChegada);
